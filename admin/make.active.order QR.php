...
if(isset($_GET['trans'])){
    ...
    $link_number_sql = "SELECT * FROM `create_qr_code` WHERE payment_code='$trans' ";
    ...
    $QR_src = "https://chart.googleapis.com/chart?cht=qr&chs=180x180&chl=$myQRcode_show_link?qr_link=$link_number_encode";
    $OR_visit = "$myQRcode_show_link?qr_link=$link_number_encode";

    // qr save in folder and DB
    $imageName = "My qr code QR123531 $link_number_encode.jpg";
    ...
    // cards db
    $update_sql = "UPDATE `create_qr_code` SET payment_status='active', QR_src='$QR_src', QR_visit='$OR_visit', QE_image_name='$imageName' WHERE payment_code='$trans'  ";
