...
if( isset($_GET['id']) && !empty($_GET['id']) ){
    ...
    $templete_time_sql = "SELECT * FROM `create_qr_code` WHERE link_number='$preview_templete_uid' ";
    ...
    if( $templete_time_fetchAssoc['payment_status']=='active' ){
        ...
        include "../../qr-code page/variables/qr variable .inc.php";
    ...
    <section id="body_section_main">
        <?php 
            if($permission_to_require=='ok'){
                require("../../qr-code page/tempplete/$templete_name");
            }else{
            ?>
