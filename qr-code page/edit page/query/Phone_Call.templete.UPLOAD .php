...
if($conn){
    ...
    // all variable upload 
    $Mobile_number_qr = htmlspecialchars($_POST['Mobile_number_qr']);
    $templete_name = "Phone_Call.templete.php";
    ...
    $sql = "INSERT INTO create_qr_code (payment_status,created_date,user_uid,templete_name,link_number,Whatsapp_number)
            VALUES ('pending','$created_date','$user_uid','$templete_name','$new_link_number','$Mobile_number_qr') ";
