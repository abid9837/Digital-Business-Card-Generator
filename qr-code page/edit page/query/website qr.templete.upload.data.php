...
if($conn){
    ...
    $templete_name = "website qr.templete.php";
    ...
    $sql = "INSERT INTO create_qr_code (payment_status,created_date,user_uid,templete_name,link_number,Website_URL)
            VALUES ('pending','$created_date','$user_uid','$templete_name','$new_link_number','$Website_URL') ";
